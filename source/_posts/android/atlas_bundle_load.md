---
title : Android动态化容器框架Atlas之bundle加载过程
categories: Android
date : 2017-06-05
---
...
[对应官网文档地址](https://alibaba.github.io/atlas/code_read/atlas_gradle_apk/atlas_atlas_gradle_apk.html)
...
在[atlas启动过程(下)][atlas_start_2]下中，解释过，application的attach方法最终会调用到`attachBaseContext`方法。
...
[bundle_load_img]: /image/android/bundle_load_img.svg
[atlas_start_2]: atlas_start_2.md
[bundle_load_part_2]: /image/android/bundle_load_part_2_img.svg
